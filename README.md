...
- [Node.js](https://nodejs.org/) and npm (for release tooling, e.g. `npm run release`)
...
The widget itself has no build step in this plugin — the Gamecenter frontend is loaded at runtime
from a CDN, see [CDN embed assets](docs/cdn-embed-assets.md).
